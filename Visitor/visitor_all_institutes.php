<?php
	...
	// To pagination 
	$select_page = mysql_query("Select * from Tbl_institute_facility where facility_status=1");
...
{
	$query = mysql_query("select * from Tbl_institute_facility where facility_status=1 order by facility_title".$limit);
}
else if(isset($_POST['btn_desc']))
{
	$query = mysql_query("select * from Tbl_institute_facility where facility_status=1 order by facility_title desc".$limit);
}
else if(isset($_POST['btn_search']))
{
	$query = mysql_query("select * from Tbl_institute_facility where facility_status=1 and facility_title like '%$_POST[txt_search]%'".$limit);
}
else
{
	$query = mysql_query("select * from Tbl_institute_facility where facility_status=1".$limit);
}
?>
    	...
    	<div class="container">
			...
			{					
				...
				<pre style="border:dashed 1px">
					  ...
					  <div style="height:100px;width:100px;margin-left:10%;padding:10px;border:solid 1px"><img align="left" src="../User-Dealer/<?php echo $row['facility_photo']; ?>" height="100px" width="100px"></div>
...
<b>Facility :</b> <br>	<?php echo $row['facility']; ?>  <br> </div> <div style="float:right"> <b>From SubCategory :</b> <?php $select1 = "select sub_category_name from Tbl_sub_category where sub_category_id = '$row[sub_category_id]'";
		...
		<?php	}
			  ...
			  <center>
			  <a href="visitor_all_institutes.php?page=1"><img src="../User-Dealer/images/first.png" height="5%" width="5%"></a> |
			  <a href="visitor_all_institutes.php?page=<?php echo $pre_page; ?>"><img src="../User-Dealer/images/prev.png" height="4%" width="4%"></a> 
			  <a href="visitor_all_institutes.php?page=<?php echo $next_page; ?>"><img src="../User-Dealer/images/next.png" height="4%" width="4%"></a> |
			  <a href="visitor_all_institutes.php?page=<?php echo $total_page; ?>"><img src="../User-Dealer/images/last.png" height="5%" width="5%"></a>
			  </center>
