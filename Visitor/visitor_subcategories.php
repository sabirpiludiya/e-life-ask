...
?>
	...
	*/
			...
			{				 
				...
				{
				?>            
				<a href="visitor_subcatproduct.php?subcat_id=<?php echo $row['sub_category_id'];  ?>"><div style="">
	...
	<?php	} ?>
			  ...
			  <center>
			  <a href="visitor_subcategories.php?cat_id=<?php echo $_GET['cat_id'];  ?>&page=1"><img src="../User-Dealer/images/first.png" height="5%" width="5%"></a> |
			  <a href="visitor_subcategories.php?cat_id=<?php echo $_GET['cat_id'];  ?>&page=<?php echo $pre_page; ?>"><img src="../User-Dealer/images/prev.png" height="4%" width="4%"></a> 
			  <a href="visitor_subcategories.php?cat_id=<?php echo $_GET['cat_id'];  ?>&page=<?php echo $next_page; ?>"><img src="../User-Dealer/images/next.png" height="4%" width="4%"></a> |
			  <a href="visitor_subcategories.php?cat_id=<?php echo $_GET['cat_id'];  ?>&page=<?php echo $total_page; ?>"><img src="../User-Dealer/images/last.png" height="5%" width="5%"></a>
			  </center>
