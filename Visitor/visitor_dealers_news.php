        	...
        	<div class="content clearfix">
                ...
                <table border="1" class="table table-striped" data-effect="fade" style="border:#330099 solid 1px;">
                  ...
                  <tbody>
					...
					$select = "select * from Tbl_dealer where dealer_id = '$_GET[dn_id]' and dealer_status=1";
				...
				<tr>
				  <td style="width:150px">
					  <h4 align="center"> <b> <?php echo "News of " .$row['company_name']; ?> </b> </h4> <p>
		...
		<hr>
				...
				<form method="post">
				   ...
				   <tbody>
					...
					$select = "select * from Tbl_news where dealer_id = '$_GET[dn_id]' and news_display_status = 1 order by news_date DESC";
					$query = mysql_query($select);
			...
			if($count>=1)
			{
				...
				<pre style="border:dashed 1px">
					  <h4 style="background:#E2E8DD"> <b> <?php echo $row['news_title']; ?> </b> </h4> 
