<?php
	...
	// To pagination 
	$select_page = mysql_query("Select * from Tbl_news where news_display_status=1");
...
{
	$query = mysql_query("select * from Tbl_news where news_display_status=1 order by news_title".$limit);
}
else if(isset($_POST['btn_desc']))
{
	$query = mysql_query("select * from Tbl_news where news_display_status=1 order by news_title desc".$limit);
}
else if(isset($_POST['btn_search']))
{
	$query = mysql_query("select * from Tbl_news where news_display_status=1 and news_title like '%$_POST[txt_search]%'".$limit);
}
else
{
	$query = mysql_query("select * from Tbl_news where news_display_status=1".$limit);
}
?>
...
?>
	...
	<section class="post-wrapper-top">
		...
		<?php	}
			  ...
			  <center>
			  <a href="visitor_all_news.php?page=1"><img src="../User-Dealer/images/first.png" height="5%" width="5%"></a> |
			  <a href="visitor_all_news.php?page=<?php echo $pre_page; ?>"><img src="../User-Dealer/images/prev.png" height="4%" width="4%"></a> 
			  <a href="visitor_all_news.php?page=<?php echo $next_page; ?>"><img src="../User-Dealer/images/next.png" height="4%" width="4%"></a> |
			  <a href="visitor_all_news.php?page=<?php echo $total_page; ?>"><img src="../User-Dealer/images/last.png" height="5%" width="5%"></a>
			  </center>
