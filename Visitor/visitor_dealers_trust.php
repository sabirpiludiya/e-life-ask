...
<b style="font-size:20px"><a href="user_donate.php?donation_id=<?php echo $row['donation_id'];?>">Donation</a></b></div>  <div style="float:right"> <b>From SubCategory :</b> <?php $select1 = "select sub_category_name from Tbl_sub_category where sub_category_id = '$row[sub_category_id]'";
