...
session_start();
	...
	// To pagination 
	$select_page = mysql_query("Select * from Tbl_category where category_status=1");
...
if(isset($_POST['btn_search']))
{
	$query = mysql_query("select * from Tbl_category where category_name like '%$_POST[txt_search]%' and category_status=1".$limit);
}
else
{
	$query = mysql_query("select * from Tbl_category where category_status=1".$limit);
}
?>
...
?>
 ...
 <DIV style="width:100%;background:url(images/logo1.bmp)">
	...
	<div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 800px; height: 200px; overflow: hidden; visibility: hidden;border:solid black 1px;">
<!-- Loading Screen -->
  ...
  <!-- /.content-wrapper -->
	...
	*/
			...
			{				 
				...
				{
				?>            
				<a href="visitor_subcategories.php?cat_id=<?php echo $row['category_id'];  ?>"><div style="">
              	<pre>  <img src="../admin/pages/tables/<?php echo $row['category_photo']; ?>" height="20%" width="20%">    <b style="font-size:36px"><?php echo $row['category_name']; ?></b></pre>
			</div></a> <br>      
				<?php } 
			}
			...
			{ ?>
					<h3 align="center" style="border:#000033 dashed 1px;color:red">Sorry, No Categories to show....</h3>
	<?php	} ?>
				
				  
					
			  <center>
			  <a href="visitor_index.php?page=1"><img src="../User-Dealer/images/first.png" height="5%" width="5%"></a> |
			  <a href="visitor_index.php?page=<?php echo $pre_page; ?>"><img src="../User-Dealer/images/prev.png" height="4%" width="4%"></a> 
			  <a href="visitor_index.php?page=<?php echo $next_page; ?>"><img src="../User-Dealer/images/next.png" height="4%" width="4%"></a> |
			  <a href="visitor_index.php?page=<?php echo $total_page; ?>"><img src="../User-Dealer/images/last.png" height="5%" width="5%"></a>
			  </center>
