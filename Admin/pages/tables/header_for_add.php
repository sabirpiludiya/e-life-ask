  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span><img src="../../dist/img/logo.bmp" height="85%" width="100%" /></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Sabir Piludiya</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  Sabir Piludiya - Admin
                  <small>Member since Oct. 2016 </small></p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
                <div class="row">
