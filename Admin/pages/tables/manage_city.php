        ...
        <div class="col-xs-12">
          ...
          <div class="box">
			...
			<form method="post">
			  ...
			  <center>
			  <a href="manage_city.php?page=1"><img src="../../dist/img/first.png" height="5%" width="5%"></a> |
			  <a href="manage_city.php?page=<?php echo $pre_page; ?>"><img src="../../dist/img/prev.png" height="4%" width="4%"></a> 
			  <a href="manage_city.php?page=<?php echo $next_page; ?>"><img src="../../dist/img/next.png" height="4%" width="4%"></a> |
			  <a href="manage_city.php?page=<?php echo $total_page; ?>"><img src="../../dist/img/last.png" height="5%" width="5%"></a>
			  </center>
