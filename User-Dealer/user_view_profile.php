	...
	<section class="post-wrapper-top">
    	<div class="container">
        	...
        	<div class="content clearfix">
				...
				<tr>
				  <td>Photo</td>
				  <td><img src="<?php echo $row['user_photo']; ?>" height="100px" width="100px"></td>
                </tr>
				...
				<tr>
				  <td>Address</td>
				  <td><?php echo $row['user_address']; ?> <br>
				  
				  
					    <?php 
						
					$select = "select * from Tbl_city where city_id = (select city_id from tbl_user where user_id = '$_SESSION[user_id]')";
					$query = mysql_query($select);
					$city_row = mysql_fetch_array($query)
					?>
				   <?php echo "City : " .$city_row['city_name']; ?></td>
                </tr>
