...
if(isset($_POST['btn_submit']))
{
	...
	else if(isset($_POST['btn_submit']) && $count==0 && $type=="Dealer")
	{
		...
		if($row['dealer_email']==$_POST['txt_email'] && $row['dealer_password']==$_POST['txt_password'])
		{
			...
			$_SESSION['dealer_status'] = $row['dealer_status'];
			?>
				<script>
...
<html class="no-js" lang="en">
    ...
    <title>Login | Welcome to E-LifeAsk</title>
...
?>
    	...
    	<div class="container clearfix" align="center">
				...
				<div style="width:60%;float:right;margin-right:0px; float:right;min-width:70%;max-width:88%">  
	...
	<div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 800px; height: 400px; overflow: hidden; float:left; visibility: hidden;border:solid black 1px;">
<!-- Loading Screen -->
<div data-u="loading" style="position: absolute; top: 0px; left: 0px;">
<div style="filter: alpha(opacity=70); opacity: 0.7; position: absolute; display: block; top: 0px; left: 0px; width: 100%; height: 100%;"></div>
<div style="position:absolute;display:block;background:url('img/loading.gif') no-repeat center center;top:0px;left:0px;width:100%;height:100%;"></div>
</div>
<div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 100%; height: 500px; overflow: hidden;">
<div data-p="112.50">
...
<!-- #endregion Jssor Slider End -->
  ...
  <div class="control-sidebar-bg"></div>
				...
				<div class="col-lg-4 col-md-4 col-sm-12" style="width:30%;height:400px;padding:5%;margin:0 auto;box-shadow:#999999 0px 0px 10px 10px;float:left;margin-left:1%;margin-top:-29.1%" align="center">
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input type="password" class="form-control" name="txt_password" placeholder="Password" >
								 ...
								 <div class="notice_add" align="left"><?php echo $err_pwd; ?></div>
						
						</div>
					
					
						<div class="form-group">
						<button type="submit" style="width:50%;font-size:16px" class="button" name="btn_submit">Sign in</button>
						</div>
						
						<div class="form-group">
						<b style="cursor:pointer"><a href="forget_pwd.php">Forget Password? Click to Receive in Email.</a></b>
						</div>
