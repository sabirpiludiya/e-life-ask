...
include "connection.php";
	...
	{	
			...
			?>
	<script>window.location.href="user_all_trusts.php";</script>
            	...
            	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                	...
                	<form id="registerform" method="post" enctype="multipart/form-data"  action="https://www.sandbox.paypal.com/cgi-bin/webscr" name="frm_paypal">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Enter Amount to donate"  name="txt_donate_money" id="n1" onKeyPress="return isNumberKey(event)" onChange="money()">
						</div>
					...
					<input type='hidden' name='return'  value='http://localhost/TestFinal/User-Dealer/user_all_trusts.php'>
