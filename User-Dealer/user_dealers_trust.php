        	...
        	<div class="content clearfix">
                ...
                <table border="1" class="table table-striped" data-effect="fade" style="border:#330099 solid 1px;">
                  ...
                  <tbody>
					...
					$select = "select * from Tbl_dealer where dealer_id = '$_GET[dt_id]' and dealer_status=1";
				...
				<tr>
				  <td style="width:150px">
					  <h4 align="center"> <b> <?php echo "Trust of " .$row['company_name']; ?> </b> </h4> <p>
