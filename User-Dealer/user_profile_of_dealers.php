				  ...
				  <div align="center">
					...
					<?php
						...
						$f = mysql_fetch_array($sel_follow);
								...
								if($f['block_status']==0)
								{ ?>
							<div align="center"> <a href="user_dealers_more_details.php?dealer_id=<?php echo $row['dealer_id'];?>" name="details" class="btnmored">More Details..</a></div> <?php
								}?> <br>
						<?php 
						...
						if($f['block_status']==0)
								{
									...
									{	
										?>
										<a href="#" dealer_id=<?php echo $row['dealer_id'];?>  class="btn_follow"><input type="button"  value="Follow"  class="btn_follow1"></a>
										<?php
									}
									else
									{
										?>
										<a href="#" follow_id=<?php  echo $f['follow_id'];?>  class="btn_unfollow"><input type="button"  value="Unfollow"  class="btn_unfollow1"></a>
										<?php
									}
								...
								{ ?>
									<b style="font-size:24px"> <?php echo "Blocked"; ?> </b> <?php
								}
						?>	
