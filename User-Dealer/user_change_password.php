...
$count == 0;
		...
		$query = mysql_query("select * from Tbl_user where user_id = $_SESSION[user_id]");
	...
	if(isset($_POST['btn_submit']))
	{
		...
		if(isset($_POST['btn_submit']) && $count == 0)
		{
			...
			$update = "update Tbl_user set user_password = '$confirm_password' where user_id = $_SESSION[user_id]";
			
			$query = mysql_query($update);
			
	?> 
 
			<script>window.location.href="user_edit_profile.php";</script>
