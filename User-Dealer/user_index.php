...
<!-- #endregion Jssor Slider End -->
	...
	*/
			...
			{				 
				...
				{
				?>            
				<a href="user_subcategories.php?cat_id=<?php echo $row['category_id'];  ?>"><div style="">
	...
	<?php	} ?>
			  ...
			  <center>
			  <a href="user_index.php?page=1"><img src="images/first.png" height="5%" width="5%"></a> |
			  <a href="user_index.php?page=<?php echo $pre_page; ?>"><img src="images/prev.png" height="4%" width="4%"></a> 
			  <a href="user_index.php?page=<?php echo $next_page; ?>"><img src="images/next.png" height="4%" width="4%"></a> |
			  <a href="user_index.php?page=<?php echo $total_page; ?>"><img src="images/last.png" height="5%" width="5%"></a>
			  </center>
