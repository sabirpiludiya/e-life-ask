...
session_start();
	...
	// To pagination 
	$select_page = mysql_query("Select * from Tbl_institute_facility i, Tbl_follow_block f where i.dealer_id = f.dealer_id and f.user_id = $_SESSION[user_id] and block_status = 0 and facility_status=1");
...
{
	$query = mysql_query("select * from Tbl_institute_facility i, Tbl_follow_block f where i.dealer_id = f.dealer_id and f.user_id = $_SESSION[user_id] and block_status = 0 and facility_status=1 order by facility_title".$limit);
}
else if(isset($_POST['btn_desc']))
{
	$query = mysql_query("select * from Tbl_institute_facility i, Tbl_follow_block f where i.dealer_id = f.dealer_id and f.user_id = $_SESSION[user_id] and block_status = 0 and facility_status=1 order by facility_title desc".$limit);
}
else if(isset($_POST['btn_search']))
{
	$query = mysql_query("select * from Tbl_institute_facility i, Tbl_follow_block f where i.dealer_id = f.dealer_id and f.user_id = $_SESSION[user_id] and block_status = 0 and facility_status=1 and facility_title like '%$_POST[txt_search]%'".$limit);
}
else
{
	$query = mysql_query("select * from Tbl_institute_facility i, Tbl_follow_block f where i.dealer_id = f.dealer_id and f.user_id = $_SESSION[user_id] and block_status = 0 and facility_status=1".$limit);
}
?>
...
<html class="no-js" lang="en">
    ...
    <title>Institutes Facility of All Dealers</title>
	...
	<section class="post-wrapper-top">
    	<div class="container">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">			   
                <h2>Institutes Facility of All Dealers</h2>
            </div>
...
<b>Facility :</b> <br>	<?php echo $row['facility']; ?>  <br> </div> <div style="float:right"> <b>From SubCategory :</b> <?php $select1 = "select sub_category_name from Tbl_sub_category where sub_category_id = '$row[sub_category_id]'";
		...
		<?php	}
			  ...
			  <center>
			  <a href="user_all_institutes.php?page=1"><img src="images/first.png" height="5%" width="5%"></a> |
			  <a href="user_all_institutes.php?page=<?php echo $pre_page; ?>"><img src="images/prev.png" height="4%" width="4%"></a> 
			  <a href="user_all_institutes.php?page=<?php echo $next_page; ?>"><img src="images/next.png" height="4%" width="4%"></a> |
			  <a href="user_all_institutes.php?page=<?php echo $total_page; ?>"><img src="images/last.png" height="5%" width="5%"></a>
			  </center>
