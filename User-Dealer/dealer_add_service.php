...
$count == 0;
	...
	if(isset($_POST['btn_submit']))
	{
		...
		if($service_title == "")
		{
			$err_service_title = "Please Enter Title of Service";
			$count++;
		}
		...
		if($service== "")
		{
			$err_service = "Please Enter Service";
			$count++;
		}
	
	
		//=======Service File=========//
		$service_photo = $_FILES['file_service_photo']['name'];
		if($service_photo== "")
		{
			$err_service_photo = "Please Select a File";
			$count++;
		}
		...
		if($service_price == "")
		{
			$err_service_price = "Please Enter Price of Service";
			$count++;
		}
	}
	...
	if(isset($_POST['btn_submit']) && $count==0)
	{
		...
		$qry = mysql_query("select * from Tbl_service where service_title = '$service_title'");
		$count = mysql_num_rows($qry);
		
		if($count > 0)
		{
			$msg = "Sorry!!! Entered Service '".$service_title."' is Already Exist.";
		}
		else
		{	
			...
			$insert = "insert into tbl_service values
			(
				'',
				'$_SESSION[dealer_id]',
				'$_POST[txt_service_title]',
				'$_POST[ddl_sub_category_name]',
				'$_POST[txt_service]',
				'$dest',
				'$_POST[txt_service_price]',
				'1'
			)";	
			...
			if($query)
			{	
				$msg = "New Service '".$service_title."' is Successfully Created.";
			}
			else
			{
...
?>
                	...
                	<form id="registerform" method="post" enctype="multipart/form-data">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Enter Title of Service"  name="txt_service_title" value="<?php echo $service_title; ?>"> 
					<div class="validation"><?php echo $err_service_title; ?></div> 
						</div>
				 ...
				 <div class="validation"><?php echo $err_sub_category_name; ?></div>
						...
						<div class="form-group">
                  			...
                  			<label>Service</label>
                  <textarea class="form-control" rows="3" placeholder="Enter Service" name="txt_service"><?php echo $service; ?></textarea>
				  <div class="validation"><?php echo $err_service; ?></div> 
						...
						<div class="form-group">
			                  ...
			                  <input type="file" id="exampleInputFile" name="file_service_photo">
				 				 <div class="validation"><?php echo $err_service_photo; ?></div>
						</div>
			...
			<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Enter Price of Service"  name="txt_service_price" value="<?php echo $service_price; ?>"> 
					<div class="validation"><?php echo $err_service_price; ?></div> 
						</div>
